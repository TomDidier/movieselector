#Advise: run in Jupyter notebook for the HTML library to work
...
gross_top = df2[['poster_path', 'title', 'vote_average']].head(10)
HTML(gross_top.to_html(escape=False))

#Parfois les images ne s'affichent pas, réessayez. 
#df2.columns = ["Poster", "Movie title","Average score", "Genre"]
df2 = df2[["poster_path","title", "vote_average", "genres"]].head(10)
print(df2)
